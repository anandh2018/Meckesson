...
my @servernames = (q{ds16.ndchealth.com:8181},
                   q{ds17.ndchealth.com:8181},
                   q{ds18.ndchealth.com:8181},
                   q{ds10.ndchealth.com:8080},
                    );

my $script     = q{/ds/common/bin/medrecon_ssl};
my $last_name  = q{OTC};
